...
\begin{figure}
 \centering
  \subcaptionbox{$ (\phi, P_{\phi}^{MIN}) $ space\label{fig2:a}}{\includegraphics[width=1.6in]{./figure1/util.eps}}\hspace{1em}%
  \subcaptionbox{$ (N_{COAL}, P_{\phi}^{MIN}) $ space\label{fig2:b}}{\includegraphics[width=1.6in]{./figure6/util2.eps}}
...
\begin{figure}
 \centering
  \subcaptionbox{Social Welfare\label{fig4:a}}{\includegraphics[width=1.6in]{./figure7/uti.eps}}\hspace{1em}%
  \subcaptionbox{Market entering percentage\label{fig4:b}}{\includegraphics[width=1.6in]{./figure4/survival.eps}}
