...
\begin{figure}
 \centering
  \includegraphics[scale=0.8]{./figure9/util}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.7]{./figure5/coals}
