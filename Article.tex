...
\begin{figure}
 \centering
  \subcaptionbox{$ (\phi, P^{MIN}) $ space\label{fig2:a}}{\includegraphics[width=1.6in]{./figure1/util}}\hspace{1em}%
  \subcaptionbox{$ (N_{COAL}, P^{MIN}) $ space\label{fig2:b}}{\includegraphics[width=1.6in]{./figure6/util2}}
