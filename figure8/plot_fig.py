...
ax.plot( range(Pmax)[1:], corre2, 'bs--', color='g', label='correlated')
...
ax2.plot( range(Pmax), rand, 'g^--', color='r', label='random')
ax2.plot( range(Pmax), corre, 'bs--', color='g', label='correlated')
